...
pygame.display.set_caption('Retro Car Racing')  # Set display name
try:
...
def main_window(curr_bg, pad_x=0, pad_y=0):
    ...
    x = pad_x + CENTRE[0]
    y = pad_y + 100
    draw_text(x, y, 'Retro Car Racing', WHITE, 100, bold=True, bar=True)  # Title
...
def credits_window(curr_bg, pad_x=0, pad_y=0):
    ...
    y = pad_y + 215
    text = 'Developer & Designer - Huynh Bao'
    draw_text(x, y, text, WHITE, 50)  # Credits #1

    y += 70
    text = 'Graphics - Huynh Bao'
    draw_text(x, y, text, WHITE, 50)  # Credits #2

    y += 70
    text = 'Menu Music - Huynh Bao'
    draw_text(x, y, text, WHITE, 50)  # Credits #3

    y += 70
    text = 'Game Music & SFX - Soundclound'
...
def fade_to_black(speed=12, show_loading=False, paused=False, car=None):
    ...
    if show_loading:
        draw_text(CENTRE[0], CENTRE[1] - 50, 'Retro Car Racing', WHITE, 100,
...
def main():
    ...
    if Intro_screen and not Debug:
        ...
        draw_text(CENTRE[0], CENTRE[1] - 150, 'Retro Car Racing', WHITE, 150, bar=True, three_d=True)
        update_screen(full_screen=True)
        play_sound('boot')
...
if __name__ == '__main__':
    ...
    try:
        Window.blit(pygame.font.Font(fonts.load(bar=True), 100).render(
            'Retro Car Racing', True, WHITE), (CENTRE[0] - 412, CENTRE[1] - 60))
        Window.blit(pygame.font.Font(fonts.load(), 100).render(
            'Testing mode', True, WHITE), (CENTRE[0] - 346, CENTRE[1] + 60))

    except FileNotFoundError:
        Window.blit(pygame.font.Font(None, 100).render('Retro Car Racing', True, WHITE),
